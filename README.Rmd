...
<!-- badges: start -->
[![master-build-macos Actions Status](https://github.com/lilin-yang/glacier/workflows/build-macos/badge.svg)](https://github.com/lilin-yang/glacier/actions)
<!-- badges: end -->
...
An example of these functions in action can be seen in `vignette("Command-line usage")`.

## Web application

A web interface for those less familiar with R is also provided. It can be
started with `webstart()`.
