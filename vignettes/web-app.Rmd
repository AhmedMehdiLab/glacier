...
* **Statistics** displays the calculated statistics.
* **Gene List** splits genes from the input into two lists based on whether they
were found in the database.
* **Gene Sets** displays which gene sets from the annotation file were not found
in the database file, and vice-versa.
